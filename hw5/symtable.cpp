...
int typecheck(FILE* outfile, astree *node) {
    ...
    switch (node->symbol) {
        ...
        case TOK_IDENT: {
            ...
            //declared_block is added for the emit file
            node->declared_block = ident_symbol->block_nr;
            break;
        }
        ...
        case '.': {
            ...
            //this is added because of the emit file
            node->declared_block = find_field->second->block_nr;
